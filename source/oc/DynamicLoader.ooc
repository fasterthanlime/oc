...
DynamicLoader: class {
    ...
    loadBackend: static func (name: String, params: BuildParams) -> Backend {
        ...
        This findPlugin(name + "_backend", params, |handle|
            ...
            callableLoadF := callableLoad as Func
            callableLoadF()
            ...
            callableConstructorF := callableConstructor as Func -> Backend
            
            backend = callableConstructorF()
            if(!backend) {
    ...
    loadFrontend: static func (name: String, params: BuildParams, pool: ParsingPool) -> FrontendFactory {
        ...
        This findPlugin(name + "_frontend", params, |handle|
            ...
            callableConstructor: Closure
            callableConstructor thunk = constructorAddress
            callableConstructorF := callableConstructor as Func -> FrontendFactory
            
            factory = callableConstructorF()
            if(!factory) {
